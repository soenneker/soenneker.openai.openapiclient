...
#nullable restore
            ...
            /// <summary>Sort order for runs by timestamp. Use `asc` for ascending order or `desc` for descending order. Defaults to `asc`.</summary>
            [QueryParameter("order")]
            public global::Soenneker.OpenAI.OpenApiClient.Evals.Item.Runs.GetOrderQueryParameterType? OrderAsGetOrderQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Filter runs by status. One of `queued` | `in_progress` | `failed` | `completed` | `canceled`.</summary>
            [QueryParameter("status")]
            public global::Soenneker.OpenAI.OpenApiClient.Evals.Item.Runs.GetStatusQueryParameterType? StatusAsGetStatusQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RunsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.OpenAI.OpenApiClient.Evals.Item.Runs.RunsRequestBuilder.RunsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
