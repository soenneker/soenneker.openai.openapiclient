...
namespace Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.Input_itemsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.Input_itemsRequestBuilder.Input_itemsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.Input_itemsRequestBuilder.Input_itemsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.Input_itemsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.Input_itemsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.Input_itemsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns a list of input items for a given response.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Input_itemsRequestBuilderGetQueryParameters 
        {
...
#nullable restore
            ...
            /// <summary>The order to return the input items in. Default is `desc`.- `asc`: Return the input items in ascending order.- `desc`: Return the input items in descending order.</summary>
            [QueryParameter("order")]
            public global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.GetOrderQueryParameterType? OrderAsGetOrderQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Input_itemsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.OpenAI.OpenApiClient.Responses.Item.Input_items.Input_itemsRequestBuilder.Input_itemsRequestBuilderGetQueryParameters>
        {
        }
    }
}
