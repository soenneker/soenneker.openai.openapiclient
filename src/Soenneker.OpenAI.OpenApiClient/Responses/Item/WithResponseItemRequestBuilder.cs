...
{
    /// <summary>
    /// Builds and executes requests for operations under \responses\{responseId}
    /// </summary>
    ...
    public partial class WithResponseItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithResponseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/responses/{responseId}{?include*,include_obfuscation*,starting_after*,stream*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.OpenAI.OpenApiClient.Responses.Item.WithResponseItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithResponseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/responses/{responseId}{?include*,include_obfuscation*,starting_after*,stream*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.OpenAI.OpenApiClient.Responses.Item.WithResponseItemRequestBuilder.WithResponseItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.OpenAI.OpenApiClient.Responses.Item.WithResponseItemRequestBuilder.WithResponseItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.OpenAI.OpenApiClient.Responses.Item.WithResponseItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.OpenAI.OpenApiClient.Responses.Item.WithResponseItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves a model response with the given ID.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithResponseItemRequestBuilderGetQueryParameters 
        {
