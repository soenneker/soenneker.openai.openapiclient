...
namespace Soenneker.OpenAI.OpenApiClient.Models
{
    ...
    public partial class BetaFunctionShellCall : IAdditionalDataHolder, IParsable
    {
        /// <summary>Execute a shell command.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellAction? Action { get; set; }
#nullable restore
#else
        public global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellAction Action { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCallCaller? Caller { get; set; }
#nullable restore
#else
        public global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCallCaller Caller { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCall"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCall CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCall();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetObjectValue<global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellAction>(global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellAction.CreateFromDiscriminatorValue); } },
                ...
                { "caller", n => { Caller = n.GetObjectValue<global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCallCaller>(global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCallCaller.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellAction>("action", Action);
            writer.WriteObjectValue<global::Soenneker.OpenAI.OpenApiClient.Models.BetaAgentTag>("agent", Agent);
            writer.WriteObjectValue<global::Soenneker.OpenAI.OpenApiClient.Models.BetaFunctionShellCallCaller>("caller", Caller);
