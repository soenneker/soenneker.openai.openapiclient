...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.VideoModel"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenAI.OpenApiClient.Models.VideoModel CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        {
            if(VideoModelBranch1 != null || VideoModelWrapper != null)
            {
                return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(VideoModelBranch1, VideoModelWrapper);
            }
