...
namespace Soenneker.OpenAI.OpenApiClient.Models
{
    ...
    public partial class ProgramOutputItemParam : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string CallId { get; set; }
#endif
        /// <summary>The unique ID of this program output item.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.ProgramOutputItemParam"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenAI.OpenApiClient.Models.ProgramOutputItemParam CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenAI.OpenApiClient.Models.ProgramOutputItemParam();
        }
        /// <summary>
