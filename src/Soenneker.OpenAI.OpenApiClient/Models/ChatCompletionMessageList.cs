...
namespace Soenneker.OpenAI.OpenApiClient.Models
{
    ...
    public partial class ChatCompletionMessageList : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public string FirstId { get; set; }
#endif
        /// <summary>Indicates whether there are more chat messages available.</summary>
        public bool? HasMore { get; set; }
        /// <summary>The identifier of the last chat message in the data array.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public static global::Soenneker.OpenAI.OpenApiClient.Models.ChatCompletionMessageList CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenAI.OpenApiClient.Models.ChatCompletionMessageList();
        }
        /// <summary>
