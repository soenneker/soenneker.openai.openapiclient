...
namespace Soenneker.OpenAI.OpenApiClient.Models
{
    ...
    public partial class ResponseItemList : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public List<global::Soenneker.OpenAI.OpenApiClient.Models.ItemResource>? Data { get; set; }
#nullable restore
#else
        public List<global::Soenneker.OpenAI.OpenApiClient.Models.ItemResource> Data { get; set; }
#endif
...
#nullable restore
        ...
        public static global::Soenneker.OpenAI.OpenApiClient.Models.ResponseItemList CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenAI.OpenApiClient.Models.ResponseItemList();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "data", n => { Data = n.GetCollectionOfObjectValues<global::Soenneker.OpenAI.OpenApiClient.Models.ItemResource>(global::Soenneker.OpenAI.OpenApiClient.Models.ItemResource.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.OpenAI.OpenApiClient.Models.ItemResource>("data", Data);
