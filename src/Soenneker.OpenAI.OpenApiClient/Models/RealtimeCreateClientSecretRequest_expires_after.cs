...
namespace Soenneker.OpenAI.OpenApiClient.Models
{
    ...
    public partial class RealtimeCreateClientSecretRequest_expires_after : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public RealtimeCreateClientSecretRequest_expires_after()
        {
            AdditionalData = new Dictionary<string, object>();
            Anchor = global::Soenneker.OpenAI.OpenApiClient.Models.RealtimeCreateClientSecretRequest_expires_after_anchor.Created_at;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.RealtimeCreateClientSecretRequest_expires_after"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenAI.OpenApiClient.Models.RealtimeCreateClientSecretRequest_expires_after CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenAI.OpenApiClient.Models.RealtimeCreateClientSecretRequest_expires_after();
        }
        /// <summary>
