...
namespace Soenneker.OpenAI.OpenApiClient.Models
{
    ...
    public partial class VoiceIdsShared : IAdditionalDataHolder, IComposedTypeWrapper, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.VoiceIdsShared"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenAI.OpenApiClient.Models.VoiceIdsShared CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        {
            if(VoiceIdsSharedBranch1 != null || VoiceIdsSharedWrapper != null)
            {
                return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(VoiceIdsSharedBranch1, VoiceIdsSharedWrapper);
            }
