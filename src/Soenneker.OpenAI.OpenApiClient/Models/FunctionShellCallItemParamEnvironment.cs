...
{
    /// <summary>
    /// Composed type wrapper for classes <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.ContainerReferenceParam"/>, <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.LocalEnvironmentParam"/>
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class FunctionShellCallItemParamEnvironment : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenAI.OpenApiClient.Models.FunctionShellCallItemParamEnvironment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenAI.OpenApiClient.Models.FunctionShellCallItemParamEnvironment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
            var result = new global::Soenneker.OpenAI.OpenApiClient.Models.FunctionShellCallItemParamEnvironment();
            if("ContainerReferenceParam".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
            {
        ...
        {
            if(ContainerReferenceParam != null)
            {
