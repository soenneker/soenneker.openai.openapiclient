...
namespace Soenneker.OpenAI.OpenApiClient.Models
{
    ...
    public partial class BetaTokenCountsResource : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public static global::Soenneker.OpenAI.OpenApiClient.Models.BetaTokenCountsResource CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenAI.OpenApiClient.Models.BetaTokenCountsResource();
        }
        /// <summary>
